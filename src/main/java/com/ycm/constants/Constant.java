package com.ycm.constants;

import com.ycm.config.Global;

public class Constant {
	
	public static final String YCM_TONGJI_SID = "YCM_TONGJI_SID";
	 ...
	 * TODO 
	 */
	public static final String TARGET_SITE_DOMAIN = Global.getConfig("target.site.domain");

	/**
	 * 是否新访客
	 */
	public static final Integer IS_NEW_VISIT_NO = 0;
