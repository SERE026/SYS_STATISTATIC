		...
		<section class="col-lg-7 connectedSortable" style="width: 100%">
			<div class="nav-tabs-custom">
				<div class="box-body">
					...
					<input type="checkbox" value="pv" name="cb_point"
						checked="checked" />&nbsp;&nbsp;浏览量(PV)&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="uv" name="cb_point"
						checked="checked" />&nbsp;&nbsp;访客数(UV)&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<input type="text" class="stat-daterange" name="timeRange"
						id="timeRange" size="30" />&nbsp;&nbsp; <input type="button"
						onclick="ok()" name="" value="确定" class="btn btn-info btn-flat" />
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content no-padding">
					...
					<div class="chart tab-pane" id="table-tab"
